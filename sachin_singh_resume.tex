...
%-------------------------------------------
    ...
    \resumeItemListStart
    \resumeItem{}
    {Working with the internal platform team to improve developer experience and productivity.}
    \resumeItem{}
    {Working on development and maintainance of "docc", an internal platform based on Kubernetes to ease application deployment and maintainance.}
    \resumeItemListEnd
